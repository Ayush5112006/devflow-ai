import type { RiskLevel, AssetType, Zone } from '../types';

// ─────────────────────────────────────────────────────────────────────────────
// Calendar-specific types
// ─────────────────────────────────────────────────────────────────────────────

export type CalTaskStatus = 'scheduled' | 'in_progress' | 'completed' | 'deferred' | 'overdue';
...
// ─────────────────────────────────────────────────────────────────────────────
// 16 realistic tasks spread across ±3 weeks
// ─────────────────────────────────────────────────────────────────────────────
...
export const calendarTasks: CalendarTask[] = [
  ...
  {
    id: 'CAL-012',
    title: 'Capacitance Measurement & Calibration',
    asset_id: 'CAP-012',
    ...
    description: 'Capacitance drift of 3.2% detected. Reactive power calibration and fuse inspection required.',
    action: 'Capacitance measurement, fuse inspection, reactive power calibration',
    last_inspection: dateOffset(-25),
    customers_affected: 1500,
    precautions: [
      'Discharge capacitors before measurement',
      'Allow 5 minutes discharge time after de-energizing',
    ],
  },
  {
    id: 'CAL-013',
